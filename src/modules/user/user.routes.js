...
import { blockUserSchema, createUserSchema, updateProfileSchema } from "./user.schema.js";
...
userRoutes.patch("/role/:userId", validBodyRequest(updateProfileSchema), userController.updateRole);
